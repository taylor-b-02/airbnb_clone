...
const NavBar = () => {
    return <div id={css.container}>
        ...
        <div id={css.buttonContainer}>
            <a href={""} id={css.hostLink}><div id={css.becomeHostButton}>Become a Host</div></a>
            <div id={css.globeDiv}>
            ...
            <div id={css.profileDiv}>
                <div id={css.menuSVG}>
                    <svg viewBox={"0 0 32 32"} focusable={"false"} width={"16"} height={"16"} display={"block"}
                         fill={"none"}
                ...
                <div id={css.profileSVG}>
                    <svg viewBox={"0 0 32 32"} aria-hidden={"true"} role={"presentation"}
                         focusable={"false"} display={"block"} fill={"#717171"} height={"100%"} width={"100%"}>
                        <path
